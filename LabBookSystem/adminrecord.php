...
//admin return event
//if return button has been clicked process it
if(isset($_GET['record'])&&isset($_GET['action'])){
	...
	header('Location: adminrecord.php?action=joined');
	exit;		
}
...
if(isset($_GET['record'])&&!isset($_GET['action'])){
	...
	//redirect to this page		
	header('Location: adminrecord.php?action=deleted');
	exit;		
}
 ...
 <div id="page-wrapper" >
            <div id="page-inner">
				...
				if(isset($_GET['action']) && $_GET['action'] == 'joined'){
					echo "<h2 class='bg-success'>You just returned a book successfully. Please check in all borrow record</h2>";
				}
				
				//if action is delete show sucess
				if(isset($_GET['action']) && $_GET['action'] == 'deleted'){
					echo "<h2 class='bg-success'>You just delete a record successfully. Please check in all borrow record</h2>";
				}
				?>
